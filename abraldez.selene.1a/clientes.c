...
int altaCliente(eClientes* clien, int lenClien){
    ...
    if(index == -1){
        ...
        idC = index + 1;
        altaCliente.idC = idC;
        getValidString("Ingrese apellido: ", "Valor no valido.", altaCliente.apellido);
        getValidString("Ingrese nombre: ", "Valor no valido.", altaCliente.nombre);
        altaCliente.sexo = getValidSexChar("Ingrese sexo: ", "Sexo no valido, ingrese f o m: ");
        getValidString("Ingrese domicilio: ", "Valor no valido", altaCliente.domicilio);
...
int modificarCliente(eClientes* clien, int lenClien){
    ...
    if (idAux == -1){
        ...
        do{
                ...
                switch(menuModi){
                    case 1:
                        getValidString("Ingrese nuevo apellido: ", "Valor no valido.", modiClien.apellido);
                        strcpy(clien[idAux].apellido, modiClien.apellido);
                        printf("Se ha modificado el dato con exito.\n\n");
                        break;
                    case 2:
                        getValidString("Ingrese nuevo nombre: ", "Valor no valido.", modiClien.nombre);
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        getValidString("Ingrese nuevo domicilio: ", "Valor no valido.", modiClien.domicilio);
...
void hardcodeoClientes(eClientes* clien){
     eClientes y[]={
        {1, "Giga", "Ana", 'f', "Galvan", 0},
        {2, "Alberto", "Luis", 'm', "Colon", 0},
        {3, "Puertas", "Juli", 'm', "Perez", 0},
        {4,  "Giga", "Julia", 'f', "Chanchi", 0},
        {5, "Rovida", "Mile", 'f', "Galvan", 0},
    };
