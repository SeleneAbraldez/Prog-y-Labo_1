...
int main(){
      eEmpleado empleados[]={               //harcodeo de datos
      {1234, "Juan", 'm', 12300},
      {2321, "Luisa", 'f',14700},
      {2122, "Ariel", 'm', 11300},
      {3423, "Laura", 'f',15600},
      ...
      {9823, "Oscar", 'm', 16500}
        ...
        /*for(int i=0; i < TAM; i++){          //pedido de datos
    ...
    mostrarEmpleados(empleados, TAM); //muestra desorde

    ordenarEmpleados(empleados, TAM); //ordena

    mostrarEmpleados(empleados, TAM); //muestra ord
    return 0;
}
