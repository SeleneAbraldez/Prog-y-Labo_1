...
int menu(){
    ...
    printf("3- Modificar\n");
    printf("4- Listar\n");
    printf("5- Listar empleadxs por sector\n");
    printf("6- Ordenar empleadxs por sector\n");
    printf("7- \n");
    printf("8- Mostrar almuerzos\n");
    printf("9- Mostrar Almuerzos por empleado\n"); // elige legajo y muestra almu de ese leg
    printf("10- Salir\n\n");
...
void ordenarEmpleadosXSector(eEmpleado x[], int tam, eSector sectores[], int tamSector){
    ...
    printf("Se han ordenado lxs empleadxs.\n");
}
...
void cargarNombreEmpleado(eEmpleado empleados[], int tamEmpleado, int legajoEmpleado, char cadena[]){
    for(int i=0; i<tamEmpleado; i++){
        if(empleados[i].legajo == legajoEmpleado){
