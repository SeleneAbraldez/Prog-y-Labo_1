...
int altaCliente(eClientes* clien, int lenClien){
    ...
    if(index == -1){
        ...
        getValidStringLen("Ingrese domicilio: ", "Valor no valido", "Dato debe ser menor a 50 caracteres", altaCliente.domicilio, 51);
...
int modificarCliente(eClientes* clien, int lenClien){
    ...
    if (idAux == -1){
        ...
        do{
                ...
                switch(menuModi){
                    case 1:
                        getValidStringLen("Ingrese nuevo apellido: ", "Valor no valido.", "Dato debe ser menor a 50 caracteres: ", modiClien.apellido, 50);
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        getValidStringLen("Ingrese nuevo domicilio: ", "Valor no valido.", "Dato debe ser menor a 50 caracteres: ", modiClien.domicilio, 51);
