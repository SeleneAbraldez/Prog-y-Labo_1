...
int controller_menu(){
    int option = -1;
        ...
        printf("3. Calcular sueldo (map) \n");
        printf("4. Guardar los datos de lxs empleadxs en el archivo info.csv (modo texto). \n");
        printf("5. Salir \n");
        option = getValidInt("\n\t*Seleccione  una opcion: ", "Opcion no valida, reintente", 0, 5);
    return option;
}
