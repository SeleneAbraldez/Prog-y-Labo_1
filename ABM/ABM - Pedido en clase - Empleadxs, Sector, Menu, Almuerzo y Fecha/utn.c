...
int menu(){
    ...
    printf("1- Alta empleadx\n");
    printf("2- Baja empleadx\n");
    printf("3- Modificar empleadx\n");
    printf("4- Listar empleadxs\n");

    printf("\n5- Alta comidas\n");
    printf("6- Baja comidas\n");
    printf("7- Listar comidas\n");

    printf("\n8- Alta almuerzos\n");
    printf("9- Baja almuerzos\n");
    printf("10- Listar almuerzos\n");
/*
    printf("9- Listar empleadxs por sector\n");
    printf("10- Ordenar empleadxs por sector\n");
    printf("11- \n");
